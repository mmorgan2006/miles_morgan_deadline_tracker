...
- View assignment details (due date, requirements) and group them by class
- Write notes and organize them in groups
- Link notes to assignments to remember what's useful
- Export notes to word documents

![App screenshot](./screenshots/assignments.png) 
![App screenshot](./screenshots/notebooks.png) 
![App screenshot](./screenshots/notepage.png)
